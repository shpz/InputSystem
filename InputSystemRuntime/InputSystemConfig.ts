...
export interface IInputSystemConfig {
     ...
     * 操作映射配置
     */
    actionMappings: Record<MappingName, Record<InputCodeKey, IActionMappingKey>>;

    /**
     * 轴映射配置
     */
    axisMappings: Record<MappingName, Record<InputCodeKey, IAxisMappingKey>>;

    /**
     * 鼠标按键对应的输入代码
     */
    mouseButtonToInputCodes: Record<number, EInputCode>;

    /**
     * 输入代码对应的映射名
     */
    inputCodeToMappingNames: Record<number, MappingName[]>
